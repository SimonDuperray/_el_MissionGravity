...
//Ces macros permettent d'utiliser dans le code des noms explicites (LED_GREEN, ...)
	...
	#define FRONT_ULTRASONIC_GPIO 	GPIOB
	#define FRONT_ULTRASONIC_PIN		GPIO_PIN_2 

	#define LEFT_ULTRASONIC_GPIO 		GPIOB
	#define LEFT_ULTRASONIC_PIN			GPIO_PIN_1 

	#define RIGHT_ULTRASONIC_GPIO 	GPIOB
	#define RIGHT_ULTRASONIC_PIN		GPIO_PIN_15 
